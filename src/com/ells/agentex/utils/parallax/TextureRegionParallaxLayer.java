...
import com.ells.agentex.utils.parallax.Utils.WH;
...
public class TextureRegionParallaxLayer extends ParallaxLayer{
	...
	private Vector2 posAdj = new Vector2(0,0);
	...
	public TextureRegionParallaxLayer(TextureRegion texRegion, Vector2 parallaxScrollRatio){
		...
		//this.posAdj = positionAdj;
		setRegionWidth(texRegion.getRegionWidth()/45f);
		setRegionHeight(texRegion.getRegionHeight()/45f);
		setParallaxRatio(parallaxScrollRatio);
	}
	
	public TextureRegionParallaxLayer(TextureRegion texRegion){
		this.texRegion = texRegion;
		//this.posAdj = positionAdj;
		setRegionWidth(Gdx.graphics.getWidth()/35);
		setRegionHeight(Gdx.graphics.getWidth()/35);
		setParallaxRatio(new Vector2(0,0));
		setTileModeX(TileMode.single);
		setTileModeY(TileMode.single);
	}
	
	public TextureRegionParallaxLayer(TextureRegion texRegion, Vector2 parallaxScrollRatio, Vector2 positionAdj){
		this.texRegion = texRegion;
		//this.posAdj = positionAdj;
		setRegionWidth(texRegion.getRegionWidth()/45f);
		setRegionHeight(texRegion.getRegionHeight()/45f);
		setParallaxRatio(parallaxScrollRatio);
		setPosAdj(positionAdj);
		setTileModeX(TileMode.single);
		setTileModeY(TileMode.single);
	}
	...
	public Vector2 getPosAdj() {
		return posAdj;
	}

	public void setPosAdj(Vector2 posAdj) {
		this.posAdj = posAdj;
	}
}
